...
public class Queries {
	...
	public static final String GET_ACCOUNT_TBL_WITH_ACCNO = "select * from account where account_no=?";
	...
	public static final String GET_ACTIVITY_HISTORY = "select b.type,b.transferid,b.transfer_details,b.transfer_date::timestamp::date,b.final_amount,b.transfer_amount from (select 1 as type,a.transferid,a.transfer_details,a.transfer_date,a.final_amount,a.transfer_amount from(select transferid, transfer_details, transfer_date, from_afteramount as final_amount,transfer_amount from transfer_funds where from_account_no=?)a union select 2 as type,a.transferid,a.transfer_details,a.transfer_date,a.final_amount,a.transfer_amount from(select transferid, transfer_details, transfer_date, to_afteramount as final_amount,transfer_amount from transfer_funds where to_account_no=?)a) b order by b.transfer_date desc";
}
