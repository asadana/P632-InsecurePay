...
/**
 * TransferFundsDao extends {@link BaseDao}.
 * This class handles transferring funds from one user
 * to another.
 */
public class TransferFundsDao extends BaseDao {

	/**
	 * TransferFundsDao is a parameterized constructor to initialize the 
	 * super class.
	 */
	 ...
	 * between two users.
	 * 
	 * @param	transferFundsBO		Contains the details about the transfer
	 * 								in form of {@link TransferFundsBO} object.
	 * 
	 * @return	Boolean		Returns a boolean object depending on if the transfer
	 * 						was successful.
	 */
