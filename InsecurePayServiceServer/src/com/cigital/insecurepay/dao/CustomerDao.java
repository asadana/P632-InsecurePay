...
/**
 * CustomerDao extends {@link BaseDao}.
 * This class handles the querying and retrieving account information 
 * for the user to view and manage.
 */
public class CustomerDao extends BaseDao {

	/**
	 * CustomerDao is a parameterized constructor to initialize the 
	 * super class.
	 */
	...
	/**
	 * getCustomerDetails is a function that queries the database
	 * to retrieve all the customer details linked to the custNo provided.
	 * 
	 * @param	custNo		Contains the customer number of the user.
	 * 
	 * @return	CustomerBO	Return the {@link CustomerBO} object containing
	...
	/**
	 * updateCustomerDetails is a function that queries the database
	 * to update the existing account information of the user.
	 * 
	 * @param	customerBO		Contains the object of {@link CustomerBO}
	 * 							with new details from the user.
	 * 
	 * @return	boolean			Return a boolean value depending on if the
